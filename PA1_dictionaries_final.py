...
def add_class(schedule): #function to add a class to the schedule
    schedule_add = input("What block would you like to add to (A,B,C)? ").lower()
    valid_actions = ["a","b","c"]
    while schedule_add not in valid_actions:
        print("Error. Please pick A, B, or C.")
        schedule_add = input("What block would you like to add to (A,B,C)? ").lower()
    if schedule_add == "a":
...
def change_class(schedule): #function to change a class in the schedule
    schedule_change = input("What block would you like to change to (A,B,C)? ").lower()
    valid_actions = ["a","b","c"]
...
def drop_class(schedule): #function to drop a class in the schedule
    schedule_drop = input("What block would you like to drop (A,B,C)? ").lower()
    valid_actions = ["a","b","c"]
...
def add_dblock(dschedule): #function to add a d block to the schedule
...
def change_dblock(dschedule): #function to change a d block in the schedule
...
def drop_dblock(dschedule): #function to drop a d block in the schedule
